  ...
  return (
    <div className="px-4 sm:px-6 md:px-9">
      <div className="flex flex-col h-[700px] justify-center items-center gap-6">
        <h1 className="text-4xl sm:text-6xl md:text-7xl lg:text-8xl font-extrabold tracking-tighter text-center">
          <span className="gradient-text">BlogNama</span> - The Essence of Desi
          World
        </h1>
        <h3 className="sm:text-xl text-zinc-500 font-medium text-center">
        ...
        <div className="flex gap-6 mt-2">
          <Link
            href="/blog"
            className="text-base md:text-xl border px-3 sm:px-6 md:px-10 py-2 rounded-lg shadow-sm hover:shadow-lg duration-300 bg-zinc-900 text-white"
          >
            View Blogs
          </Link>
          <Link
            href="/getstarted"
            className="text-base md:text-xl border px-3 sm:px-6 md:px-10 py-2 rounded-lg shadow-sm hover:shadow-md duration-[0.4s]"
          >
            Get Started
          </Link>
        </div>
